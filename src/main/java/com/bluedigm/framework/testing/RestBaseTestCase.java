...
@ContextConfiguration(loader = TestGenericWebXmlContextLoader.class, locations = {
		...
		"classpath*:/conf/spring/applicationContext-rest.xml",
		"classpath*:/conf/spring/applicationContext-web.xml",
		"classpath*:/conf/spring/applicationContext-Config.xml",
		"classpath:/conf/spring/restApplication-servlet.xml" })
@TransactionConfiguration(transactionManager = "transactionManager", defaultRollback = true)
@Transactional
public class RestBaseTestCase {
	
	/**
	 * Instantiates a new rest base test case.
	 */
	public RestBaseTestCase() {
