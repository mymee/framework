...
import com.sbsch.cms.framework.util.email.folder.SystemHandler;
import com.sbsch.cms.framework.util.email.folder.SystemHandlerImpl;
import com.sbsch.cms.framework.util.email.util.FileObject;
import com.sbsch.cms.framework.util.email.util.FileUtil;
import com.sbsch.cms.framework.util.email.util.MailComparator;
